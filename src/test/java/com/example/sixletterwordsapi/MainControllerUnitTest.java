...
public class MainControllerUnitTest {
    ...
    @Test
    public void testPstResult() throws Exception {
        ArrayList<String> list1 = new ArrayList<String>();
        list1.add("na");
        list1.add("vi");
        list1.add("de");
        ...
        mockMvc.perform(post("/api/list")
                        .content(mapper.writeValueAsString(fileinfo1))
    ...
    @Test
    public void testHistoryResult() throws Exception {
        ArrayList<String> list1 = new ArrayList<String>();
        list1.add("na");
        list1.add("vi");
        list1.add("de");
        ...
        given(sixLetterRepository.findAll()).willReturn(fileInfos);

        mockMvc.perform(get("/api/histories"))
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.result[0].id", is("1")))
                .andExpect(jsonPath("$.result[0].fileList", is(list1)))
                .andExpect(jsonPath("$.result[0].name", is("file1")));
